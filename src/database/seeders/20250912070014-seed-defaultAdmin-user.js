...
module.exports = {
  async up (queryInterface) {
    ...
    await queryInterface.bulkInsert('tbl_users', [{
      ...
      password: '$2b$12$ONKoxjHM1U1Cjgp/v33A0.AD6XvPapgShF0YijpttuPuH78zastxm', // hashed
      role: 'admin',
      first_name: 'super',
      last_name: 'admin',
      status: 10,
  ...
  async down (queryInterface) {
    ...
    await queryInterface.bulkDelete('tbl_users', { email: 'admin@site.com' });
